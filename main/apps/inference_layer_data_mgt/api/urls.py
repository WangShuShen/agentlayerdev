...
from main.apps.inference_layer_data_mgt.actors import RawDataManager, InferenceResultManager, ClosedloopDataManager, DeployModelDataManager
urlpatterns = [
    ...
    path('inference_layer_data_mgt/DeployModelDataManager/add_positionid_data', DeployModelDataManager.add_positionid_data),
    path('inference_layer_data_mgt/DeployModelDataManager/delete_positionid_data', DeployModelDataManager.delete_positionid_data),
    path('inference_layer_data_mgt/DeployModelDataManager/delete_all_positionid_data', DeployModelDataManager.delete_all_positionid_data),
]